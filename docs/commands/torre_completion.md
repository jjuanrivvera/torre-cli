...
```
torre completion [bash|zsh|fish|powershell]
```

### Examples

```
  torre completion zsh > "${fpath[1]}/_torre"
  torre completion bash > /etc/bash_completion.d/torre
  torre completion fish > ~/.config/fish/completions/torre.fish
```
