...
Generate safety configuration for AI agents that drive torre.
...
* [torre agent guard](torre_agent_guard.md)	 - Generate agent-safety config that blocks destructive torre operations
